...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    if (empty($jenis_daftar)) {
      ...
      // jika sudah tidak ada kolom yang kosong maka di eksekusi ke database
    ...
    <div class = "col-md-7">
      <div class = "card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-sm-5">
              <a href="reportform.php"><button type="submit" class="btn btn-primary">Export Data ke PDF</button></a>
            </div>
          </div>
        </div>
      </div>
